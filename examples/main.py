...
if __name__ == '__main__':
    ...
    # Hyperparameters
    level = config["hyperparameters"]["level"]
    adj_paths = config["hyperparameters"]["adj_paths"]
    generate_new_negative_target = config["hyperparameters"]["generate_new_negative_target"]
